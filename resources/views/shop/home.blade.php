...
<div class="slider-area">
    <div class="swiper-container slider-active">
        <div class="swiper-wrapper">
            <!--Single Slider Start-->
            <div class="single-slider swiper-slide animation-style-01" style="background-image: url('public/kidolshop/images/slider/banneemas.jpg');">
                <div class="container">
                    <div class="slider-content">
                        <!-- <h5 class="sub-title text-primary-one">Tha hồ <span class="text-primary-one">mua sắm</span> <br> tất cả phụ kiện thời trang</h5> -->
                        <h2 class="main-title text-primary-one">Ưu đãi lớn!</h2>
                        <p>Thêm vào <span class="text-info">GIỎ HÀNG</span> để được giảm giá, số lượng có hạn!</p>
            ...
            <!--Single Slider Start-->
            <div class="single-slider swiper-slide animation-style-01" style="background-image: url('public/kidolshop/images/slider/bannera.jpg');">
                <div class="container" style="text-align:right;">
                    <div class="slider-content">
                        <h5 class="sub-title sub-title-right text-primary-one">Nhập: <span class="text-info">SALE100K</span> <br> Giảm 100K cho mọi đơn hàng</h5>
                        <h2 class="main-title text-primary-one">Ngày đặc biệt!</h2>
                        <p class="text-primary-one">Nhập: <span class="text-info">SALE10</span> để được giảm 10%, số lượng có hạn!</p>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-image">
                    <img src="public/kidolshop/images/banner/banner3.jpg" alt="">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-content">
                    <h2 class="title">Siêu phẩm mới được EMAS ra mắt trong sự kiện thời trang Xuân Hè 2023..</h2>
                    <p>Các mã giảm giá ưu đãi hiện có trên cửa hàng:</p>
                    <ul>
                        <li> SALE100K: Giảm 100K cho đơn hàng tổng giá trị trên 1.000.000 đồng </li>
                        <li> SALE10: Giảm 10% cho đơn hàng tổng giá trị đơn hàng. </li>
                    </ul>
                    <div class="about-btn">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-11">
                <div class="section-title text-center">
                    ...
                    <p>Những sản phẩm nổi bật hiện đang bán chạy trên cửa hàng.</p>
                </div>
            </div>
        </div>
        <div class="product-wrapper">
            <div class="product-tab-menu">
                <ul class="nav justify-content-center" role="tablist">
                    <li>
                        <a class="active text-primary" data-toggle="tab" href="#tab3" role="tab">Bán chạy</a>
                    </li>
                    <li>
                        <a class="text-primary" data-toggle="tab" href="#tab2" role="tab">Nổi bật</a>
                    </li>
                    <li>
                        <a class="text-primary" data-toggle="tab" href="#tab1" role="tab">Đang Sale</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-9 col-sm-11">
                <div class="section-title text-center">
                    ...
                    <p>Những bài viết xu hướng nổi bật về thời trang trong năm nay.</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="single-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <div class="articles-date">
                                    <p><span class="text-primary" >{{$blog->created_at}}</span></p>
                                </div>
