...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('public/kidolshop/images/logoww.png')}}">
    ...
    <link rel="stylesheet" href="{{asset('public/kidolshop/css/style7.css')}}">
    <style>
        ...
        <!-- <div class="top-notification-bar text-center">
            <div class="container">
                <div class="notification-entry">
                     <p>HOT: Giảm 10% cho mọi đơn hàng. <a href="{{URL::to('/store')}}">Mua ngay!</a></p> 
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="header-logo">
                                <a href="{{URL::to('/home')}}"><img src="{{asset('public/kidolshop/images/logo/a.png')}}" alt=""></a>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="copyright-wrapper text-center d-lg-flex align-items-center justify-content-between">
                    ...
                    <div class="copyright-content">
                        <p>Copyright 2023 &copy; <a href="https://hasthemes.com/">EMAS</a> . All Rights Reserved</p>
                    </div>
                    <!--Right End-->
